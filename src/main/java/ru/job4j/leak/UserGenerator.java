...
public class UserGenerator implements Generate {
    ...
    public static final String PATH_NAMES = "src/main/java/ru/job4j/leak/files/names.txt";
    public static final String PATH_SURNAMES = "src/main/java/ru/job4j/leak/files/surnames.txt";
    public static final String PATH_PATRONS = "src/main/java/ru/job4j/leak/files/patr.txt";
    ...
    public static List<User> getUsers(Random random) {
        return new UserGenerator(random).users;
    }
}
